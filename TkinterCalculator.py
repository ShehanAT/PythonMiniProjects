...
# Function to add in the enty of text display
...
# Function to change to sign of number 
def sign_change():
    global calc_operator
    if calc_operator[0] == '-':
...
# Powers of 10 
tens_power = Button(tk_calc, button_params, text='10^x',
...
third_root = Button(tk_calc, button_params, text='\u00B3\u221A',
                   command=square_root).grid(row=4, column=1, sticky="nsew")
...
button_6 = Button(tk_calc, button_params_main, text='6',
                 command=lambda:button_click('6')).grid(row=7, column=0, sticky="nsew")
...
button_4 = Button(tk_calc, button_params_main, text='4',
                 command=lambda:button_click('4')).grid(row=7, column=2, sticky="nsew")
